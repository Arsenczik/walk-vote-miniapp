...
def get_user_vibe(user_id):
    ...
    achievements.append({
        "emoji": "🐱",
"name": "Организованный Комочек",
"description": "Первый шаг в большое путешествие. Добро пожаловать в MiauZu!"    })
    ...
    if len(events_created) >= 1:
        achievements.append({
            "emoji": "📢",
            "name": "Заводила",
"description": "Вожак MiauZu! Ты сделал первый шаг, чтобы собрать друзей вместе."        })
